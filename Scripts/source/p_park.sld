...
<sld:StyledLayerDescriptor version="1.0.0" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <sld:NamedLayer>
    <sld:Name>p_park</sld:Name>
    <sld:UserStyle>
      <sld:Name>Style1</sld:Name>
      <sld:FeatureTypeStyle>
        <sld:FeatureTypeName>p_park</sld:FeatureTypeName>
        <sld:Rule>
          <sld:Name>p_park</sld:Name>
          <sld:Title>p_park</sld:Title>
          <sld:MinScaleDenominator>0</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>20000.0000000002</sld:MaxScaleDenominator>
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:Mark>
          ...
          <sld:TextSymbolizer>
            ...
            <sld:Fill>
              <sld:CssParameter name="fill">#3E9B43</sld:CssParameter>
