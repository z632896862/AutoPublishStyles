...
<sld:StyledLayerDescriptor version="1.0.0" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <sld:NamedLayer>
    <sld:Name>l_railway</sld:Name>
    <sld:UserStyle>
      <sld:Name>Style1</sld:Name>
      <sld:FeatureTypeStyle>
        <sld:FeatureTypeName>l_railway</sld:FeatureTypeName>
        <sld:Rule>
          <sld:Name>l_railway</sld:Name>
          <sld:Title>l_railway</sld:Title>
          <sld:MinScaleDenominator>0</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>2000</sld:MaxScaleDenominator>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#D5D4D4</sld:CssParameter>
              <sld:CssParameter name="stroke-width">2.90909090909091</sld:CssParameter>
          ...
          <sld:LineSymbolizer>
            <sld:Stroke>
              ...
              <sld:CssParameter name="stroke-width">2.909</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#717171</sld:CssParameter>
          ...
          <sld:TextSymbolizer>
            ...
            <sld:Fill>
              <sld:CssParameter name="fill">#8A8A8A</sld:CssParameter>
        ...
        <sld:Rule>
          <sld:Name>l_railway</sld:Name>
          <sld:Title>l_railway</sld:Title>
          <sld:MinScaleDenominator>2000.2</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>12000</sld:MaxScaleDenominator>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#D5D4D4</sld:CssParameter>
              <sld:CssParameter name="stroke-width">1.45454545454545</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
              <sld:CssParameter name="stroke-dasharray">5 5</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#686868</sld:CssParameter>
              <sld:CssParameter name="stroke-width">1.4545</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
        ...
        <sld:Rule>
          ...
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#D5D4D4</sld:CssParameter>
              <sld:CssParameter name="stroke-width">0.872727272727273</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
              <sld:CssParameter name="stroke-dasharray">5 5</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#686868</sld:CssParameter>
              <sld:CssParameter name="stroke-width">0.8727</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
