...
<sld:StyledLayerDescriptor version="1.0.0" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <sld:NamedLayer>
    <sld:Name>l_mainroad</sld:Name>
    <sld:UserStyle>
      <sld:Name>Style1</sld:Name>
      <sld:FeatureTypeStyle>
        <sld:FeatureTypeName>l_mainroad</sld:FeatureTypeName>
        <sld:Rule>
          <sld:Name>l_mainroad</sld:Name>
          <sld:Title>l_mainroad</sld:Title>
        ...
        <sld:Rule>
          ...
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#F8FBBF</sld:CssParameter>
              <sld:CssParameter name="stroke-width">0.84</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
