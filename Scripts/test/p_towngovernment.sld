...
<sld:StyledLayerDescriptor version="1.0.0" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <sld:NamedLayer>
    <sld:Name>p_towngovernment</sld:Name>
    <sld:UserStyle>
      <sld:Name>Style1</sld:Name>
      <sld:FeatureTypeStyle>
        <sld:FeatureTypeName>p_towngovernment</sld:FeatureTypeName>
        <sld:Rule>
          <sld:Name>p_towngovernment</sld:Name>
          <sld:Title>p_towngovernment</sld:Title>
          <sld:MinScaleDenominator>136494.693347386</sld:MinScaleDenominator>
          ...
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:Mark>
                ...
                <sld:Fill>
                  <sld:CssParameter name="fill">#D81E06</sld:CssParameter>
