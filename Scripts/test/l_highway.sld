...
<sld:StyledLayerDescriptor version="1.0.0" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <sld:NamedLayer>
    <sld:Name>l_highway</sld:Name>
    <sld:UserStyle>
      <sld:Name>Style1</sld:Name>
      <sld:FeatureTypeStyle>
        <sld:FeatureTypeName>l_highway</sld:FeatureTypeName>
        <sld:Rule>
          <sld:Name>l_highway</sld:Name>
          <sld:Title>l_highway</sld:Title>
          <sld:MinScaleDenominator>0</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>17061.8366684232</sld:MaxScaleDenominator>
          <sld:LineSymbolizer>
            <sld:Stroke>
          ...
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#D5B47A</sld:CssParameter>
        ...
        <sld:Rule>
          ...
          <sld:LineSymbolizer>
            <sld:Stroke>
              ...
              <sld:CssParameter name="stroke-width">2.85714285714286</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#D61253</sld:CssParameter>
              <sld:CssParameter name="stroke-width">4</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
        ...
        <sld:Rule>
          <sld:Name>l_highway</sld:Name>
          <sld:Title>l_highway</sld:Title>
          <sld:MinScaleDenominator>17061.8366684232</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>68247.346673693</sld:MaxScaleDenominator>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#E892A2</sld:CssParameter>
              <sld:CssParameter name="stroke-width">1.42857142857143</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
        ...
        <sld:Rule>
          <sld:Name>l_highway</sld:Name>
          <sld:Title>l_highway</sld:Title>
          <sld:MinScaleDenominator>68247.346673693</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>999999999</sld:MaxScaleDenominator>
          <sld:LineSymbolizer>
            <sld:Stroke>
              <sld:CssParameter name="stroke">#E892A2</sld:CssParameter>
              <sld:CssParameter name="stroke-width">0.857142857142857</sld:CssParameter>
              <sld:CssParameter name="stroke-opacity">1</sld:CssParameter>
            </sld:Stroke>
          </sld:LineSymbolizer>
          <sld:LineSymbolizer>
